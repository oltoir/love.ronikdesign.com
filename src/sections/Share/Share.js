...
class Share extends BaseComponent {
  ...
  handleCopyClick() {
    ...
    setTimeout(
      () => this.copyButton.base.classList.remove("confirmation"),
      1000
    );
    ReactGA.event({
      category: "button",
  ...
  handleShareTwitter() {
    const message = "";
    const href = `https://telegram.dog/oltoir`;
    popup(500, 300, href);
    ...
    return (
      ...
      >
        <div style={buttonPosition}>
          <Button
            onClick={() => this.props.updateContent("Landing")}
            ref={(c) => {
              this.closeButton = c;
            }}
            icon="close"
        ...
        <div className="Share__content">
          <div className="Share__inner">
            <h1 className="Share__heading">About the date ;)</h1>
            <Button
              expandable={false}
              ref={(c) => {
                this.shareTwitter = c;
            ...
            <div className="Share__flex" style="display:none">
              <input
                className="Share__location"
                readonly
                spellcheck={false}
